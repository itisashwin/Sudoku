...
/**
 * This is the base class for implementing a Sudoku board. The board is
 * represented by a two dimensional array. It provides the methods to get and set cell values.
...
public class SudokuBoard {
    final int EMPTY_CELL = 0;      // Empty cells marker
